...
from app.application.webhook_policy import validate_webhook_url
...
class PaymentCreate(BaseModel):
    ...
    webhook_url: AnyHttpUrl = Field(examples=["http://webhook-echo:9000/webhooks/payments"])

    @field_validator("webhook_url")
    @classmethod
    def allowed_webhook(cls, value: AnyHttpUrl) -> AnyHttpUrl:
        validate_webhook_url(str(value), map(str, get_settings().webhook_allowed_origins))
        return value
